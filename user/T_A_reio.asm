...
user/_T_A_reio:     file format elf64-littleriscv
...
int main() {
   ...
   c:	304080e7          	jalr	772(ra) # 30c <fork>
    
    if(pid == 0) {
  10:	ed2d                	bnez	a0,8a <main+0x8a>
        close(1);
  12:	4505                	li	a0,1
  14:	00000097          	auipc	ra,0x0
  18:	328080e7          	jalr	808(ra) # 33c <close>
        open("output.txt", O_WRONLY | O_CREATE);
  1c:	20100593          	li	a1,513
  20:	00001517          	auipc	a0,0x1
  24:	83850513          	addi	a0,a0,-1992 # 858 <malloc+0x10e>
  28:	00000097          	auipc	ra,0x0
  2c:	32c080e7          	jalr	812(ra) # 354 <open>

        char *argv[] = {"echo", "this", "is", "redirected", "echo", 0};
  30:	00001797          	auipc	a5,0x1
  34:	84878793          	addi	a5,a5,-1976 # 878 <malloc+0x12e>
  38:	6388                	ld	a0,0(a5)
  3a:	678c                	ld	a1,8(a5)
  3c:	6b90                	ld	a2,16(a5)
  3e:	6f94                	ld	a3,24(a5)
  40:	7398                	ld	a4,32(a5)
  42:	779c                	ld	a5,40(a5)
  44:	fca43023          	sd	a0,-64(s0)
  48:	fcb43423          	sd	a1,-56(s0)
  4c:	fcc43823          	sd	a2,-48(s0)
  50:	fcd43c23          	sd	a3,-40(s0)
  54:	fee43023          	sd	a4,-32(s0)
  58:	fef43423          	sd	a5,-24(s0)
        
	exec("echo", argv);
  5c:	fc040593          	addi	a1,s0,-64
  60:	00000517          	auipc	a0,0x0
  64:	7d050513          	addi	a0,a0,2000 # 830 <malloc+0xe6>
  68:	00000097          	auipc	ra,0x0
  6c:	2e4080e7          	jalr	740(ra) # 34c <exec>
        printf("exec failed! \n");
  70:	00000517          	auipc	a0,0x0
  74:	7f850513          	addi	a0,a0,2040 # 868 <malloc+0x11e>
  78:	00000097          	auipc	ra,0x0
  7c:	614080e7          	jalr	1556(ra) # 68c <printf>
        exit(1);
  80:	4505                	li	a0,1
  82:	00000097          	auipc	ra,0x0
  86:	292080e7          	jalr	658(ra) # 314 <exit>
    } else  wait((int*) 0);
  8a:	4501                	li	a0,0
  8c:	00000097          	auipc	ra,0x0
  90:	290080e7          	jalr	656(ra) # 31c <wait>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3fc:	4b850513          	addi	a0,a0,1208 # 8b0 <digits>
 400:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4c8:	3ecb8b93          	addi	s7,s7,1004 # 8b0 <digits>
 ...
 608:	2a490913          	addi	s2,s2,676 # 8a8 <malloc+0x15e>
        while(*s != 0){
...
free(void *ap)
{
 ...
 6d0:	1fc7b783          	ld	a5,508(a5) # 8c8 <freep>
 ...
 6fe:	00e6ea63          	bltu	a3,a4,712 <free+0x50>
{
 ...
 740:	18f73623          	sd	a5,396(a4) # 8c8 <freep>
}
 744:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 772:	15a53503          	ld	a0,346(a0) # 8c8 <freep>
 ...
 79a:	13290913          	addi	s2,s2,306 # 8c8 <freep>
  if(p == (char*)-1)
 79e:	5afd                	li	s5,-1
 7a0:	a88d                	j	812 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 7a2:	00000797          	auipc	a5,0x0
 7a6:	12e78793          	addi	a5,a5,302 # 8d0 <base>
 7aa:	00000717          	auipc	a4,0x0
 7ae:	10f73f23          	sd	a5,286(a4) # 8c8 <freep>
 7b2:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7d4:	0ea73c23          	sd	a0,248(a4) # 8c8 <freep>
      return (void*)(p + 1);
