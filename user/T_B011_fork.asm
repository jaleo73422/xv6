...
user/_T_B011_fork:     file format elf64-littleriscv
...
int main() {
   ...
   c:	2e0080e7          	jalr	736(ra) # 2e8 <fork>
	if(pid > 0){
  10:	02a04063          	bgtz	a0,30 <main+0x30>
		printf("parent: child=%d\n", pid);
		pid = wait((int *) 0);
		// pid = wait(0);
		printf("child %d is done\n", pid);
	} else if(pid == 0){
  14:	e931                	bnez	a0,68 <main+0x68>
		printf("child: exiting\n");
  16:	00001517          	auipc	a0,0x1
  1a:	82a50513          	addi	a0,a0,-2006 # 840 <malloc+0x11a>
  1e:	00000097          	auipc	ra,0x0
  22:	64a080e7          	jalr	1610(ra) # 668 <printf>
		exit(0);
  26:	4501                	li	a0,0
  28:	00000097          	auipc	ra,0x0
  2c:	2c8080e7          	jalr	712(ra) # 2f0 <exit>
		printf("parent: child=%d\n", pid);
  30:	85aa                	mv	a1,a0
  32:	00000517          	auipc	a0,0x0
  36:	7de50513          	addi	a0,a0,2014 # 810 <malloc+0xea>
  3a:	00000097          	auipc	ra,0x0
  3e:	62e080e7          	jalr	1582(ra) # 668 <printf>
		pid = wait((int *) 0);
  42:	4501                	li	a0,0
  44:	00000097          	auipc	ra,0x0
  48:	2b4080e7          	jalr	692(ra) # 2f8 <wait>
  4c:	85aa                	mv	a1,a0
		printf("child %d is done\n", pid);
  ...
  64:	290080e7          	jalr	656(ra) # 2f0 <exit>
		printf("fork error\n");
  68:	00000517          	auipc	a0,0x0
  6c:	7e850513          	addi	a0,a0,2024 # 850 <malloc+0x12a>
  70:	00000097          	auipc	ra,0x0
  74:	5f8080e7          	jalr	1528(ra) # 668 <printf>
  78:	b7dd                	j	5e <main+0x5e>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3d8:	49450513          	addi	a0,a0,1172 # 868 <digits>
 3dc:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4a4:	3c8b8b93          	addi	s7,s7,968 # 868 <digits>
 ...
 5e4:	28090913          	addi	s2,s2,640 # 860 <malloc+0x13a>
        while(*s != 0){
...
free(void *ap)
{
 ...
 6ac:	1d87b783          	ld	a5,472(a5) # 880 <freep>
 ...
 6da:	00e6ea63          	bltu	a3,a4,6ee <free+0x50>
{
 ...
 71c:	16f73423          	sd	a5,360(a4) # 880 <freep>
}
 720:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 74e:	13653503          	ld	a0,310(a0) # 880 <freep>
 ...
 776:	10e90913          	addi	s2,s2,270 # 880 <freep>
  if(p == (char*)-1)
 77a:	5afd                	li	s5,-1
 77c:	a88d                	j	7ee <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 77e:	00000797          	auipc	a5,0x0
 782:	10a78793          	addi	a5,a5,266 # 888 <base>
 786:	00000717          	auipc	a4,0x0
 78a:	0ef73d23          	sd	a5,250(a4) # 880 <freep>
 78e:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7b0:	0ca73a23          	sd	a0,212(a4) # 880 <freep>
      return (void*)(p + 1);
