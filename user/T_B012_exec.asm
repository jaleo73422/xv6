...
user/_T_B012_exec:     file format elf64-littleriscv
...
int main() {
   ...
   c:	7d850513          	addi	a0,a0,2008 # 7e0 <malloc+0xea>
  10:	fca43c23          	sd	a0,-40(s0)
	argv[1] = "hello";
  14:	00000797          	auipc	a5,0x0
  18:	7d478793          	addi	a5,a5,2004 # 7e8 <malloc+0xf2>
  ...
  34:	7c050513          	addi	a0,a0,1984 # 7f0 <malloc+0xfa>
  38:	00000097          	auipc	ra,0x0
  3c:	600080e7          	jalr	1536(ra) # 638 <printf>
	exit(0);
  40:	4501                	li	a0,0
  42:	00000097          	auipc	ra,0x0
  46:	27e080e7          	jalr	638(ra) # 2c0 <exit>
...
gets(char *buf, int max)
{
 ...
 13c:	1a0080e7          	jalr	416(ra) # 2d8 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 18e:	176080e7          	jalr	374(ra) # 300 <open>
  if(fd < 0)
 ...
 19e:	17e080e7          	jalr	382(ra) # 318 <fstat>
 1a2:	892a                	mv	s2,a0
  close(fd);
 1a4:	8526                	mv	a0,s1
 1a6:	00000097          	auipc	ra,0x0
 1aa:	142080e7          	jalr	322(ra) # 2e8 <close>
  return r;
}
 1ae:	854a                	mv	a0,s2
...
memmove(void *vdst, const void *vsrc, int n)
{
 ...
 20e:	0800                	addi	s0,sp,16
  ...
  src = vsrc;
  if (src > dst) {
 210:	02b57663          	bgeu	a0,a1,23c <memmove+0x32>
    while(n-- > 0)
 214:	02c05163          	blez	a2,236 <memmove+0x2c>
 ...
 22e:	fed70fa3          	sb	a3,-1(a4)
    while(n-- > 0)
 232:	fee79ae3          	bne	a5,a4,226 <memmove+0x1c>
    src += n;
    while(n-- > 0)
      *--dst = *--src;
  }
 ...
 240:	95b2                	add	a1,a1,a2
    while(n-- > 0)
 242:	fec05ae3          	blez	a2,236 <memmove+0x2c>
 ...
 25c:	00d70023          	sb	a3,0(a4)
    while(n-- > 0)
 260:	fee79ae3          	bne	a5,a4,254 <memmove+0x4a>
 264:	bfc9                	j	236 <memmove+0x2c>
...
memcpy(void *dst, const void *src, uint n)
{
 ...
 2ac:	f62080e7          	jalr	-158(ra) # 20a <memmove>
}
 2b0:	60a2                	ld	ra,8(sp)
 2b2:	6402                	ld	s0,0(sp)
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3a8:	46450513          	addi	a0,a0,1124 # 808 <digits>
 3ac:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 474:	398b8b93          	addi	s7,s7,920 # 808 <digits>
 ...
 5b4:	25090913          	addi	s2,s2,592 # 800 <malloc+0x10a>
        while(*s != 0){
...
free(void *ap)
{
 ...
 67c:	1a87b783          	ld	a5,424(a5) # 820 <freep>
 ...
 6aa:	00e6ea63          	bltu	a3,a4,6be <free+0x50>
{
 ...
 6ec:	12f73c23          	sd	a5,312(a4) # 820 <freep>
}
 6f0:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 71e:	10653503          	ld	a0,262(a0) # 820 <freep>
 ...
 746:	0de90913          	addi	s2,s2,222 # 820 <freep>
  if(p == (char*)-1)
 74a:	5afd                	li	s5,-1
 74c:	a88d                	j	7be <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 74e:	00000797          	auipc	a5,0x0
 752:	0da78793          	addi	a5,a5,218 # 828 <base>
 756:	00000717          	auipc	a4,0x0
 75a:	0cf73523          	sd	a5,202(a4) # 820 <freep>
 75e:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 780:	0aa73223          	sd	a0,164(a4) # 820 <freep>
      return (void*)(p + 1);
 ...
 7ce:	b7e080e7          	jalr	-1154(ra) # 348 <sbrk>
  if(p == (char*)-1)
