...
user/_T_A_exec_2:     file format elf64-littleriscv
...
int main() {
  ...
  1a:	88a78793          	addi	a5,a5,-1910 # 8a0 <malloc+0x150>
  1e:	638c                	ld	a1,0(a5)
  20:	6790                	ld	a2,8(a5)
  22:	6b94                	ld	a3,16(a5)
  24:	6f98                	ld	a4,24(a5)
  ...
  54:	80050513          	addi	a0,a0,-2048 # 850 <malloc+0x100>
  ...
  6e:	7f650513          	addi	a0,a0,2038 # 860 <malloc+0x110>
  ...
  8e:	7ee50513          	addi	a0,a0,2030 # 878 <malloc+0x128>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 402:	4d250513          	addi	a0,a0,1234 # 8d0 <digits>
 406:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4ce:	406b8b93          	addi	s7,s7,1030 # 8d0 <digits>
 ...
 60e:	2be90913          	addi	s2,s2,702 # 8c8 <malloc+0x178>
        while(*s != 0){
...
free(void *ap)
{
 ...
 6d6:	2167b783          	ld	a5,534(a5) # 8e8 <freep>
 ...
 704:	00e6ea63          	bltu	a3,a4,718 <free+0x50>
{
 ...
 746:	1af73323          	sd	a5,422(a4) # 8e8 <freep>
}
 74a:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 778:	17453503          	ld	a0,372(a0) # 8e8 <freep>
 ...
 7a0:	14c90913          	addi	s2,s2,332 # 8e8 <freep>
  if(p == (char*)-1)
 7a4:	5afd                	li	s5,-1
 7a6:	a88d                	j	818 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 7a8:	00000797          	auipc	a5,0x0
 7ac:	14878793          	addi	a5,a5,328 # 8f0 <base>
 7b0:	00000717          	auipc	a4,0x0
 7b4:	12f73c23          	sd	a5,312(a4) # 8e8 <freep>
 7b8:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
