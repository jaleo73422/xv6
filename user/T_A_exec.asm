...
user/_T_A_exec:     file format elf64-littleriscv
...
int main() {
   ...
   c:	81078793          	addi	a5,a5,-2032 # 818 <malloc+0x110>
  10:	638c                	ld	a1,0(a5)
  12:	6790                	ld	a2,8(a5)
  14:	6b94                	ld	a3,16(a5)
  16:	6f98                	ld	a4,24(a5)
  18:	739c                	ld	a5,32(a5)
  1a:	fcb43423          	sd	a1,-56(s0)
  1e:	fcc43823          	sd	a2,-48(s0)
  22:	fcd43c23          	sd	a3,-40(s0)
  26:	fee43023          	sd	a4,-32(s0)
  2a:	fef43423          	sd	a5,-24(s0)
        
	exec("echo", argv);
  2e:	fc840593          	addi	a1,s0,-56
  32:	00000517          	auipc	a0,0x0
  36:	7be50513          	addi	a0,a0,1982 # 7f0 <malloc+0xe8>
  3a:	00000097          	auipc	ra,0x0
  3e:	2d0080e7          	jalr	720(ra) # 30a <exec>
	printf("exec failed!\n");
  42:	00000517          	auipc	a0,0x0
  46:	7c650513          	addi	a0,a0,1990 # 808 <malloc+0x100>
  4a:	00000097          	auipc	ra,0x0
  4e:	600080e7          	jalr	1536(ra) # 64a <printf>
	exit(0);
  52:	4501                	li	a0,0
