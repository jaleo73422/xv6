...
user/_T_A_exec_3:     file format elf64-littleriscv
...
int main() {
  ...
  10:	306080e7          	jalr	774(ra) # 312 <fork>

    if(pid == 0) {
  14:	e939                	bnez	a0,6a <main+0x6a>
        char *argv[] = {"echo", "this", "is", "echo", 0};
  16:	00001797          	auipc	a5,0x1
  1a:	89a78793          	addi	a5,a5,-1894 # 8b0 <malloc+0x160>
  1e:	638c                	ld	a1,0(a5)
  20:	6790                	ld	a2,8(a5)
  22:	6b94                	ld	a3,16(a5)
  24:	6f98                	ld	a4,24(a5)
  26:	739c                	ld	a5,32(a5)
  28:	fcb43023          	sd	a1,-64(s0)
  2c:	fcc43423          	sd	a2,-56(s0)
  30:	fcd43823          	sd	a3,-48(s0)
  34:	fce43c23          	sd	a4,-40(s0)
  38:	fef43023          	sd	a5,-32(s0)
        
	exec("echoooooo", argv);
  3c:	fc040593          	addi	a1,s0,-64
  40:	00001517          	auipc	a0,0x1
  44:	81050513          	addi	a0,a0,-2032 # 850 <malloc+0x100>
  48:	00000097          	auipc	ra,0x0
  4c:	30a080e7          	jalr	778(ra) # 352 <exec>
        printf("exec failed! \n");
  50:	00001517          	auipc	a0,0x1
  54:	81050513          	addi	a0,a0,-2032 # 860 <malloc+0x110>
  58:	00000097          	auipc	ra,0x0
  5c:	63a080e7          	jalr	1594(ra) # 692 <printf>
        exit(1);
  60:	4505                	li	a0,1
  ...
  6e:	80650513          	addi	a0,a0,-2042 # 870 <malloc+0x120>
  72:	00000097          	auipc	ra,0x0
  76:	620080e7          	jalr	1568(ra) # 692 <printf>
        wait(&status);
  7a:	fec40513          	addi	a0,s0,-20
  7e:	00000097          	auipc	ra,0x0
  82:	2a4080e7          	jalr	676(ra) # 322 <wait>
        printf("this child exited with status %d \n", status);
  86:	fec42583          	lw	a1,-20(s0)
  8a:	00000517          	auipc	a0,0x0
  8e:	7fe50513          	addi	a0,a0,2046 # 888 <malloc+0x138>
  92:	00000097          	auipc	ra,0x0
  96:	600080e7          	jalr	1536(ra) # 692 <printf>
    }
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 402:	4e250513          	addi	a0,a0,1250 # 8e0 <digits>
 406:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4ce:	416b8b93          	addi	s7,s7,1046 # 8e0 <digits>
 ...
 60e:	2ce90913          	addi	s2,s2,718 # 8d8 <malloc+0x188>
        while(*s != 0){
...
free(void *ap)
{
 ...
 6d6:	2267b783          	ld	a5,550(a5) # 8f8 <freep>
 ...
 704:	00e6ea63          	bltu	a3,a4,718 <free+0x50>
{
 ...
 746:	1af73b23          	sd	a5,438(a4) # 8f8 <freep>
}
 74a:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 778:	18453503          	ld	a0,388(a0) # 8f8 <freep>
 ...
 7a0:	15c90913          	addi	s2,s2,348 # 8f8 <freep>
  if(p == (char*)-1)
 7a4:	5afd                	li	s5,-1
 7a6:	a88d                	j	818 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 7a8:	00000797          	auipc	a5,0x0
 7ac:	15878793          	addi	a5,a5,344 # 900 <base>
 7b0:	00000717          	auipc	a4,0x0
 7b4:	14f73423          	sd	a5,328(a4) # 8f8 <freep>
 7b8:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7da:	12a73123          	sd	a0,290(a4) # 8f8 <freep>
      return (void*)(p + 1);
