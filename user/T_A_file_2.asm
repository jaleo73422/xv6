...
user/_T_A_file_2:     file format elf64-littleriscv
...
int main() {
  ...
  12:	7d250513          	addi	a0,a0,2002 # 7e0 <malloc+0xe4>
  16:	00000097          	auipc	ra,0x0
  1a:	2f0080e7          	jalr	752(ra) # 306 <open>
  1e:	84aa                	mv	s1,a0
        
	int w = write(fd, "123456789\n", 4);
  20:	4611                	li	a2,4
  22:	00000597          	auipc	a1,0x0
  26:	7ce58593          	addi	a1,a1,1998 # 7f0 <malloc+0xf4>
  2a:	00000097          	auipc	ra,0x0
  2e:	2bc080e7          	jalr	700(ra) # 2e6 <write>
  32:	862a                	mv	a2,a0
	printf("%d %d \n", fd, w);
  34:	85a6                	mv	a1,s1
  36:	00000517          	auipc	a0,0x0
  3a:	7ca50513          	addi	a0,a0,1994 # 800 <malloc+0x104>
  3e:	00000097          	auipc	ra,0x0
  42:	600080e7          	jalr	1536(ra) # 63e <printf>
        exit(0);
  46:	4501                	li	a0,0
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3ae:	46650513          	addi	a0,a0,1126 # 810 <digits>
 3b2:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 47a:	39ab8b93          	addi	s7,s7,922 # 810 <digits>
 ...
 5ba:	25290913          	addi	s2,s2,594 # 808 <malloc+0x10c>
        while(*s != 0){
...
free(void *ap)
{
 ...
 682:	1aa7b783          	ld	a5,426(a5) # 828 <freep>
 ...
 6b0:	00e6ea63          	bltu	a3,a4,6c4 <free+0x50>
{
 ...
 6f2:	12f73d23          	sd	a5,314(a4) # 828 <freep>
}
 6f6:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 724:	10853503          	ld	a0,264(a0) # 828 <freep>
 ...
 74c:	0e090913          	addi	s2,s2,224 # 828 <freep>
  if(p == (char*)-1)
 750:	5afd                	li	s5,-1
 752:	a88d                	j	7c4 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 754:	00000797          	auipc	a5,0x0
 758:	0dc78793          	addi	a5,a5,220 # 830 <base>
 75c:	00000717          	auipc	a4,0x0
 760:	0cf73623          	sd	a5,204(a4) # 828 <freep>
 764:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 786:	0aa73323          	sd	a0,166(a4) # 828 <freep>
      return (void*)(p + 1);
